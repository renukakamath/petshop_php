...
<head>
	<title>Dog Shop | View_Vendor</title>
...
foreach ($res as $key ) 
	{
		?>
		<tr>
	<td><?php echo $key['v_fname']?></td>
	<td><?php echo $key['v_lname']?></td>
	<td><?php echo $key['v_email']?></td>
	<td><?php echo $key['v_gender']?></td>
	<!-- <td><img src="<?php echo $key['image']?>" width="70px" height="70px"></td> -->
	<td><?php echo $key['v_phno']?></td>
	<td><?php echo $key['v_hno']?></td>
	<td><?php echo $key['v_street']?></td>
	<td><?php echo $key['v_district']?></td>
	<td><?php echo $key['v_pin']?></td>
	<td><?php echo $key['breed']?></td>
